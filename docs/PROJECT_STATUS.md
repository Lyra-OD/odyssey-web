...
**Changelog** (max 5)
- 17 sept 2026 — Invité **mobile / tactile** : ciel = image (`guest-still-v2`), **zéro WebGL** (clics + premier paint). Desktop garde le canvas.
...
| **UX mobile** | 🟡 | Wizard : [`MOBILE_WIZARD_STRATEGY.md`](MOBILE_WIZARD_STRATEGY.md). **Sanctuaire invité** : still `guest-still-v2` (pas de WebGL) |
