...
**Changelog** (max 5)
- 9 sept 2026 — **Quiet Luxury Lots 1–5** : masquer Total $ hors craft ; tiroir collab `z-[80]` au-dessus de la gate composition ; paille `#E4D96F` Création assistée ; copy wizard adoucie (Coffre, musique, proche, composition) + footnotes ; hub « Le film de leur vie » (promise/next) ; landing invité « En mémoire de/d’ » + privacy + CTA Partager. Catalog régénéré. Surface seulement.
