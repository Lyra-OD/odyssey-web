...
**Changelog** (max 5)
- 8 sept 2026 — **Accueil clarifié puis resserré en mode agence** : la home reste clairement **B2C**, mais le `Process` retrouve sa promesse la plus forte (`Leur vie en cinéma`, `Trois temps, un hommage`, `Coffre à souvenirs, Entourage, Cinéma`) et la section [`Pricing`](../src/components/Pricing.tsx) quitte encore davantage le réflexe “cartes SaaS” pour un triptyque plus éditorial, plus respirant, avec hiérarchie recentrée sur l’hommage. Le CTA final partenaires reste une preuve secondaire et redevient bien locale-aware (`/${lang}/partners`).
