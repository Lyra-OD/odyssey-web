# VERSION A — NDA validée légale

**Type :** temp · **Version :** **A** · **Vérité pour :** entente prête à signer (validée légale).  
**Dernière MAJ :** 21 août 2026 · **Carte :** [`../README.md`](../README.md)

**Changelog** (max 5)
- 21 août 2026 — étiquetée **Version A** · guide A/B/C : [`NDA_UNILATERAL_BROUILLON_QC.md`](NDA_UNILATERAL_BROUILLON_QC.md).
