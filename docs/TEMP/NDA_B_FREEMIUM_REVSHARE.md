# VERSION B — NDA Freemium / RevShare

**Type :** temp · **Version :** **B** · **Vérité pour :** entente + protection modèle $ (cible Patrice).  
**Dernière MAJ :** 21 août 2026 · **Carte :** [`../README.md`](../README.md)

**Changelog** (max 5)
- 21 août 2026 — **Version B** = A + Freemium / Héritage-Éternité / RevShare + alinéa §5 modèles financiers.
