# VERSION D — NDA renforcé (B + polish démo / clauses)

**Type :** temp · **Version :** **D** · **Vérité pour :** cible signature Patrice après revalidation avocat.  
**Dernière MAJ :** 21 août 2026 · **Carte :** [`../README.md`](../README.md)

**Changelog** (max 5)
- 21 août 2026 — Parties Réceptrices multiples (optionnel) + solidarité + blocs signature.
- 21 août 2026 — §2 : dédoublonnage bullet / paragraphe démos.
- 21 août 2026 — **Version D** = B − exclusion 3(e) · non-contournement précisé · démos/accès plateforme explicites · infos mémorisées · § PI allégé.

> **Différence vs B :** mêmes Freemium / Héritage-Éternité / RevShare ; clauses cœur durcies pour démo live et exécutabilité.  
> **Statut :** revalidation avocat **obligatoire** (surtout non-contournement, durée 3 ans, non-utilisation concurrente).  
