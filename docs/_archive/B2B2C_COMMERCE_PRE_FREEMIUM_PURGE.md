# Odyssey — Commerce B2B2C v2 (référence architecture) — ARCHIVE

> **ARCHIVED — juillet 2026.** Contient coexistence jetons / wholesale / états Phase ⏳.  
> **Doc vivante :** [`../B2B2C_COMMERCE.md`](../B2B2C_COMMERCE.md).

**Last updated: July 2026 · Version: Freemium V1 Pivot · Modèle Bulletproof (pré-purge doc)**
