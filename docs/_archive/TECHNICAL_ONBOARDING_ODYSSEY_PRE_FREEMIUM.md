...
> **ARCHIVED — juillet 2026.** Pré-purge jetons. **Ne plus utiliser pour onboarding.**  
> Hub actuel : [`../TECHNICAL_ONBOARDING_V1.md`](../TECHNICAL_ONBOARDING_V1.md) · Canon : [`../FREEMIUM_V1_PIVOT.md`](../FREEMIUM_V1_PIVOT.md).

**Last code review: July 2026 · B2B2C v2 + storyboard foundations (historique)**
