...
**Changelog** (max 5)
- 25 août 2026 — lien parcours Sanctuaire (prologue séparé du wizard, tiroir global).
...
- [`product/SANCTUARY_USER_JOURNEY.md`](product/SANCTUARY_USER_JOURNEY.md) — **parcours onboarding** (prologue · hub · tiroir · navigation)
