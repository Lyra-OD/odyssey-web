...
3. **Invité mobile / tactile** — **pas de WebGL**. Image locale `public/craft/sky/guest-still-v2.jpg` (`GuestSkyStill`). Le chunk Three ne se télécharge pas. Desktop inchangé.
