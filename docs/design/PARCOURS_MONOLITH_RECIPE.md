...
**Changelog** (max 5)
- 2 sept 2026 — **T-invite-C** : typo droite Option C (UNE PRÉSENCE. / Toucher l’étoile) · DOM hors WebGL · souffle approach.
- 2 sept 2026 — **T-invite-1–3** : copy + arcs SVG (supersédé par Option C).
