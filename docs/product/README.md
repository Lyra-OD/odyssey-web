...
- Nouvelle spec d’étape, runbook produit, note Sanctuaire / Scanner **neuve**

## Ne pas mettre ici

- Labs craft (éclipse, ciel) → [`../craft/`](../craft/README.md)  
- Frames Figma / copy → [`../design/`](../design/README.md)  
- Prix / RevShare → racine FREEMIUM / RevShare ou [`../business/`](../business/README.md)

Index : [`../README.md`](../README.md) § product.
