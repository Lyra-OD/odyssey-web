...
**Changelog** (max 5)
- 2 sept 2026 — **T2-reward-perf** : ForceRenderLoop 30 fps overlay · setRevealT ~4 Hz · HeroStar sans veil/grain.
...
**Statut :** **T2-reward-perf** ✅ · prochaine **T2-2** · suite nav P1/P2 · P0 ✅.
