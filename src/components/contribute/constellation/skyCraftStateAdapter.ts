...
function gasFromLegacy(
  ...
  return {
    ...baseLayer({
      ...
      position: g.position,
      rotation: g.rotation ?? LAYER_IDENTITY.rotation,
      scale: g.scale,
      color: g.color,
...
function starsFromLegacy(
  ...
  return {
    ...baseLayer({
      ...
      rotation: s.rotation ?? LAYER_IDENTITY.rotation,
    ...
    layers: {
      ...
      cosmicDust: {
        ...baseLayer({
          ...
          position: d.position,
          rotation: d.rotation ?? LAYER_IDENTITY.rotation,
          scale: d.scale,
          color: d.tint,
      ...
      dustLanes: {
        ...baseLayer({
          ...
          rotation: lanes.rotation ?? LAYER_IDENTITY.rotation,
          scale: lanes.scale,
          color: lanes.lane,
      ...
      zodiacal: {
        ...baseLayer({
          ...
          position: z.position,
          rotation: z.rotation ?? LAYER_IDENTITY.rotation,
          scale: z.scale,
          color: z.warm,
      ...
      aurora: {
        ...baseLayer({
          ...
          position: a.position,
          rotation: a.rotation ?? LAYER_IDENTITY.rotation,
          scale: a.scale,
          color: a.cool,
