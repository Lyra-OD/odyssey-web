...
/** T-open-5 — dernière stagger (delay 240 + durée 320) après départ expand. */
export const HUB_OPEN_STAGGER_END_MS = 560;
/**
...
/** Fin transition open — expand + stagger contenu (T-open-5). */
export const HUB_FREEZE_TOTAL_MS =
  HUB_FREEZE_PANEL_AT_MS + HUB_OPEN_STAGGER_END_MS;
