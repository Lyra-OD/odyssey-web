...
describe("guest photo quota (Sanctuaire)", () => {
  ...
  it("construit le préfixe storage scopé session invité", () => {
    const projectId = "11111111-1111-4111-8111-111111111111";
    const tokenId = "22222222-2222-4222-8222-222222222222";
    const sessionId = "33333333-3333-4333-8333-333333333333";
    expect(guestContributeStoragePrefix(projectId, tokenId, sessionId)).toBe(
      `projects/${projectId}/contribute/${tokenId}/${sessionId}/`,
    );
  });
